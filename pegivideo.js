    ...
    template: `
      <div class="player">
        <div class="player-controls">
          <div id="stop">
            <button v-on:click.prevent="stop" title="Stop" class="player-control">
          ...
          <div id="play">
            <button v-on:click.prevent="playing = !playing" :title="(playing) ? 'Pause' : 'Play'" class="player-control">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <div id="seek">
            ...
            <div class="player-time">
              <div class="player-time-current">{{ this.currentSecondsConverted }}</div>
              <div class="player-title">
                <p>Louis-Emmanuel Jadin &mdash; Nocturne No. 3 in G minor&nbsp;&nbsp;</p>
                <p>Louis-Emmanuel Jadin &mdash; Nocturne No. 3 in G minor&nbsp;&nbsp;</p>
              </div>
              <div class="player-time-total">{{ this.durationSecondsConverted }}</div>
            </div>
          </div>
          <div id="download" v-show="!showVolume">
            <button v-on:click.prevent="download" class="player-control" title="Download">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <div id="loop" v-show="!showVolume">
            <button v-on:click.prevent="looping = !looping" class="player-control" title="Loop">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <div id="volume">
            <button v-on:click.prevent="" v-on:mouseenter="showVolume = true" v-on:mouseleave="showVolume = false" :title="volumeTitle" class="player-control">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
